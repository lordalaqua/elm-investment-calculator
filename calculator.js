...
var _user$project$Main$rateTypetoString = function (t) {
	return _elm_lang$core$Native_Utils.eq(t, _user$project$Main$Monthly) ? 'Mês' : 'Ano';
};
var _user$project$Main$stringToRateType = function (t) {
	return _elm_lang$core$Native_Utils.eq(t, 'Mês') ? _user$project$Main$Monthly : _user$project$Main$Yearly;
};
